---
markup: mmark
title: "The State of Data Science Today"
summary: "What does the data science landscape look like today?"
author: "David Nield"
date: 2019-11-19
output:
  blogdown::html_page:
...
current <- read_csv("2019_multiple_choice_responses.csv") %>% 
  rename(surveyduration = `Time from Start to Finish (seconds)`,
         ...
         recommended_first_language = Q19,
         recommended_first_language_other_text = Q19_OTHER_TEXT,
...
# write_csv(current, "2019_cleaned.csv")
```
...
I also expect that the [*tidymodels*](https://www.tidyverse.org/blog/2018/08/tidymodels-0-0-1/) framework, developed by Max Kuhn, the author of "caret", and other authors in the tidyverse to succeed *caret* to begin emerging as a leading machine learning framework for R users in 2020 as the ecosystem continues to mature.
